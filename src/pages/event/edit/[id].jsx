...
const EditEvent = ({post}) => {
  ...
  const handleSubmit = async(e)=>{
    ...
    const apiEventData = {
      ...
      const res = await axios.put(`https://goofy-purple-lungfish.glitch.me/api/v1/event/${post._id}`, apiEventData, {
            headers: {
  ...
  return (
    <div className="create_event">
      <div className="create_event_heading pt-32">
        <h1 className="text-green-500 font-extrabold create_edit">EDIT AN EVENT</h1>
...
export async function getServerSideProps(context){
  try {
    ...
    const res = await axios.get(`https://goofy-purple-lungfish.glitch.me/api/v1/event/${eventId}`,options)
