...
const Userdetails = ({user}) => {
  ...
  const handleSubmit = async(e)=>{
    ...
    try {
      const res = await axios.put(`https://goofy-purple-lungfish.glitch.me/api/v1/userdashboard/update`, formData, {
        headers: {
...
export async function getServerSideProps(context){
  try {
    ...
    const res = await axios.get(`https://goofy-purple-lungfish.glitch.me/api/v1/userdashboard`,options)
